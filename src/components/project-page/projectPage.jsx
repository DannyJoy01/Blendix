...
const ProjectPage = () => {
  return (
    <div className="w-full mt-[20px] md:mt-[60px] flex flex-col items-center justify-center px-4">
      {/* Header */}
      <div className="w-full text-center mb-10">
        <p className="text-dix_green text-[18px] md:text-dix_seaBlue md:text-base font-normal">
          Now, the good stuff.
        </p>
        <h1 id="my-work" className=" text-dix_white text-[32px] md:text-[42px] font-bold">
          My Work
        </h1>
      </div>
